...
const Utility = require('./scrape-utilities.js');
 ...
 const scrape = async () => {
    ...
    try {
        await driver.get('https://cityoflewisville.legistar.com/Calendar.aspx');
        ...
        for (let i = 0; i < rows.length; i++) {
			...
			link = 'https://cityoflewisville.legistar.com/' + elements[6].querySelector('a').getAttribute('href');
